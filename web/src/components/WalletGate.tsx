	...
	if (
		...
		return (
			<div className="min-h-screen bg-pattern relative flex flex-col items-center justify-center px-4">
				<div className="gradient-orb pointer-events-none" style={{ background: "#e6007a", top: "-200px", right: "-100px" }} />
				<div className="gradient-orb pointer-events-none" style={{ background: "#4cc2ff", bottom: "-200px", left: "-100px" }} />
				...
				<div className="relative z-10 card max-w-lg w-full space-y-8 py-12 px-8 text-center">
					<div className="space-y-2">
						...
						<p className="text-text-secondary text-sm sm:text-base leading-relaxed">
							This app unlocks after you connect a Polkadot browser extension (Polkadot.js,
							SubWallet, Talisman, …). Your keys stay in the extension.
						</p>
					</div>
					<div className="flex justify-center">

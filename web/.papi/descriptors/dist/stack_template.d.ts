...
type IStorage = {
    System: {
         ...
         */
        Events: StorageDescriptor<[], Anonymize<Idpikn8tlm2sd0>, false, never>;
        /**
    ...
    TemplatePallet: {
         ...
         */
        Restaurants: StorageDescriptor<[Key: SS58String], null, true, never>;
        /**
...
type ICalls = {
    ...
    Sudo: {
         ...
         */
        sudo: TxDescriptor<Anonymize<I5nbui6i24nf5c>>;
        /**
         * Authenticates the sudo key and dispatches a function call with `Root` origin.
         ...
         */
        sudo_unchecked_weight: TxDescriptor<Anonymize<Id6sqr1bhgrdp8>>;
        /**
         ...
         * The dispatch origin for this call must be _Signed_.
         */
        sudo_as: TxDescriptor<Anonymize<I5q9hu2ehhah9e>>;
        /**
    ...
    TemplatePallet: {
         ...
         */
        create_restaurant: TxDescriptor<undefined>;
        /**
    ...
    Revive: {
         ...
         */
        eth_substrate_call: TxDescriptor<Anonymize<I5jig53283510t>>;
        /**
         ...
         */
        dispatch_as_fallback_account: TxDescriptor<Anonymize<I5nbui6i24nf5c>>;
    };
};
type IEvent = {
    System: {
         ...
         * An extrinsic failed.
         */
        ExtrinsicFailed: PlainDescriptor<Anonymize<I6vv73lfp08tap>>;
        /**
         * `:code` was updated.
         */
         ...
         */
        RejectedInvalidAuthorizedUpgrade: PlainDescriptor<Anonymize<I3vsalbokstkpd>>;
    };
    ParachainSystem: {
        /**
    ...
    Sudo: {
         ...
         */
        Sudid: PlainDescriptor<Anonymize<Iccgqmnbhqknul>>;
        /**
         ...
         */
        SudoAsDone: PlainDescriptor<Anonymize<Iccgqmnbhqknul>>;
    };
    CollatorSelection: {
        /**
    ...
    Revive: {
         ...
         */
        EthExtrinsicRevert: PlainDescriptor<Anonymize<I2vhqll3f27qa1>>;
    };
};
type IError = {
    System: {
...
type IRuntimeCalls = {
    ...
    BlockBuilder: {
         ...
         * this block or not.
         */
        apply_extrinsic: RuntimeDescriptor<[extrinsic: Binary], Anonymize<Ifd8mm0c9iu945>>;
        /**
    ...
    TransactionPaymentCallApi: {
         ...
         */
        query_call_info: RuntimeDescriptor<[call: Anonymize<I5n8aospecr555>, len: number], Anonymize<I6spmpef2c7svf>>;
        /**
         * Query fee details of a given encoded `Call`.
         */
        query_call_fee_details: RuntimeDescriptor<[call: Anonymize<I5n8aospecr555>, len: number], Anonymize<Iei2mvq0mjvt81>>;
        /**
    ...
    ReviveApi: {
         ...
         */
        call: RuntimeDescriptor<[origin: SS58String, dest: FixedSizeBinary<20>, value: bigint, gas_limit: Anonymize<Iasb8k6ash5mjn>, storage_deposit_limit: Anonymize<I35p85j063s0il>, input_data: Binary], Anonymize<If1dg0hdaoa20r>>;
        /**
         * Instantiate a new contract.
         *
         * See `[crate::Pallet::bare_instantiate]`.
         */
        instantiate: RuntimeDescriptor<[origin: SS58String, value: bigint, gas_limit: Anonymize<Iasb8k6ash5mjn>, storage_deposit_limit: Anonymize<I35p85j063s0il>, code: Anonymize<I9sijb8gfrns29>, data: Binary, salt: Anonymize<I4s6vifaf8k998>], Anonymize<I2sna9rto1tsop>>;
        /**
         ...
         */
        upload_code: RuntimeDescriptor<[origin: SS58String, code: Binary, storage_deposit_limit: Anonymize<I35p85j063s0il>], Anonymize<Iietcai10e0g>>;
        /**
         ...
         */
        get_storage: RuntimeDescriptor<[address: FixedSizeBinary<20>, key: FixedSizeBinary<32>], Anonymize<I2v3cub08148p0>>;
        /**
         ...
         * doesn't exist, or doesn't have a contract then `Err` is returned.
         */
        get_storage_var_key: RuntimeDescriptor<[address: FixedSizeBinary<20>, key: Binary], Anonymize<I2v3cub08148p0>>;
        /**
...
export type Stack_templateDispatchError = Anonymize<I3d4s5aherfihl>;
...
export type Stack_templateCallData = Anonymize<I5n8aospecr555> & {
    value: {
        type: string;
    };
};
type AllInteractions = {
    ...
    errors: {
        ...
        TemplatePallet: ['AlreadyClaimed', 'NotClaimOwner', 'ClaimNotFound', 'AlreadyCustomer', 'AlreadyRestaurant', 'AlreadyRider'];

...
type IStorage = {
    System: {
         ...
         */
        Events: StorageDescriptor<[], Anonymize<If9tepffk7fplk>, false, never>;
        /**
...
type ICalls = {
    ...
    Sudo: {
         ...
         */
        sudo: TxDescriptor<Anonymize<I53r9nsdcbm8nq>>;
        /**
         * Authenticates the sudo key and dispatches a function call with `Root` origin.
         ...
         */
        sudo_unchecked_weight: TxDescriptor<Anonymize<Id1p118lt8umru>>;
        /**
         ...
         * The dispatch origin for this call must be _Signed_.
         */
        sudo_as: TxDescriptor<Anonymize<I6sfj5cpgemker>>;
        /**
    ...
    Revive: {
         ...
         */
        eth_substrate_call: TxDescriptor<Anonymize<I9sh7976hfl4gr>>;
        /**
         ...
         */
        dispatch_as_fallback_account: TxDescriptor<Anonymize<I53r9nsdcbm8nq>>;
    };
};
type IEvent = {
    System: {
         ...
         * An extrinsic failed.
         */
        ExtrinsicFailed: PlainDescriptor<Anonymize<I17d8bvpi5i32m>>;
        /**
         * `:code` was updated.
         */
         ...
         */
        RejectedInvalidAuthorizedUpgrade: PlainDescriptor<Anonymize<Iej77q9tjdrrl5>>;
    };
    ParachainSystem: {
        /**
    ...
    Sudo: {
         ...
         */
        Sudid: PlainDescriptor<Anonymize<Ie3ie0ogjkd5k5>>;
        /**
         ...
         */
        SudoAsDone: PlainDescriptor<Anonymize<Ie3ie0ogjkd5k5>>;
    };
    CollatorSelection: {
        /**
    ...
    Revive: {
         ...
         */
        EthExtrinsicRevert: PlainDescriptor<Anonymize<I3f1fbduravs2g>>;
    };
};
type IError = {
    System: {
...
type IRuntimeCalls = {
    ...
    BlockBuilder: {
         ...
         * this block or not.
         */
        apply_extrinsic: RuntimeDescriptor<[extrinsic: Binary], Anonymize<I7kc3unucakb8c>>;
        /**
    ...
    TransactionPaymentCallApi: {
         ...
         */
        query_call_info: RuntimeDescriptor<[call: Anonymize<I9fhcesfule2ml>, len: number], Anonymize<I6spmpef2c7svf>>;
        /**
         * Query fee details of a given encoded `Call`.
         */
        query_call_fee_details: RuntimeDescriptor<[call: Anonymize<I9fhcesfule2ml>, len: number], Anonymize<Iei2mvq0mjvt81>>;
        /**
    ...
    ReviveApi: {
         ...
         */
        call: RuntimeDescriptor<[origin: SS58String, dest: FixedSizeBinary<20>, value: bigint, gas_limit: Anonymize<Iasb8k6ash5mjn>, storage_deposit_limit: Anonymize<I35p85j063s0il>, input_data: Binary], Anonymize<Idp8hmvdee2rt0>>;
        /**
         * Instantiate a new contract.
         *
         * See `[crate::Pallet::bare_instantiate]`.
         */
        instantiate: RuntimeDescriptor<[origin: SS58String, value: bigint, gas_limit: Anonymize<Iasb8k6ash5mjn>, storage_deposit_limit: Anonymize<I35p85j063s0il>, code: Anonymize<I9sijb8gfrns29>, data: Binary, salt: Anonymize<I4s6vifaf8k998>], Anonymize<I2m9tftrq37fhl>>;
        /**
         ...
         */
        upload_code: RuntimeDescriptor<[origin: SS58String, code: Binary, storage_deposit_limit: Anonymize<I35p85j063s0il>], Anonymize<I895fehiit1c63>>;
        /**
         ...
         */
        get_storage: RuntimeDescriptor<[address: FixedSizeBinary<20>, key: FixedSizeBinary<32>], Anonymize<I7hcs1k0qqj05i>>;
        /**
         ...
         * doesn't exist, or doesn't have a contract then `Err` is returned.
         */
        get_storage_var_key: RuntimeDescriptor<[address: FixedSizeBinary<20>, key: Binary], Anonymize<I7hcs1k0qqj05i>>;
        /**
...
export type Stack_templateDispatchError = Anonymize<I18lvh321u5g5h>;
...
export type Stack_templateCallData = Anonymize<I9fhcesfule2ml> & {
    value: {
        type: string;
    };
};
type AllInteractions = {
    storage: {
        ...
        TemplatePallet: ['Claims', 'Customers'];
    ...
    tx: {
        ...
        TemplatePallet: ['create_claim', 'revoke_claim', 'create_customer'];
    ...
    events: {
        ...
        TemplatePallet: ['ClaimCreated', 'ClaimRevoked', 'CustomerCreated'];
    ...
    errors: {
        ...
        TemplatePallet: ['AlreadyClaimed', 'NotClaimOwner', 'ClaimNotFound', 'AlreadyCustomer'];
